...
def build_production_orchestrator(
    ...
    if not quality_ready or not delivery_ready:
        ...
        # ProductionOrchestrator is upstream of VideoBaseE2E/FinalizationE2E.
        # It deliberately cannot turn a declarative APPROVED value into a
        # downstream-ready state. The request model rejects APPROVED entirely.
        status = ProductionOrchestratorStatus.WAITING_FOR_HUMAN_REVIEW
        next_action = "RUN_VIDEO_BASE_E2E_THEN_FINALIZATION_E2E_HUMAN_REVIEW"
